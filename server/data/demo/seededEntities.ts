...
export const SEEDED_KNOWN_ENTITIES: Record<string, RecipientIdentity> = {
  ...
  'bescom.bill@sbi': {
    vpa: 'bescom.bill@sbi',
    name: 'Bangalore Electricity Supply Co (BESCOM)',
    category: 'merchant',
    kycStatus: 'verified',
    accountAgeDays: 3200,
    baseRiskScore: 1,
    reportCount1930: 0,
    isKnownMule: false,
    deviceFingerprint: 'UTILITY_BILLER_CERT_001',
    ipLocation: 'Bengaluru Utility Gateway',
    avgDailyVolume: 45000000
  },
  'tata.power@icici': {
    vpa: 'tata.power@icici',
    ...
    reportCount1930: 0,
    isKnownMule: false,
    deviceFingerprint: 'UTILITY_BILLER_CERT_002',
    ipLocation: 'Mumbai Utility Gateway',
    avgDailyVolume: 52000000
  },
  'apollo.pharmacy@axis': {
    vpa: 'apollo.pharmacy@axis',
    name: 'Apollo Hospitals Enterprise Ltd (Pharmacy)',
    category: 'merchant',
    kycStatus: 'verified',
    accountAgeDays: 2800,
    baseRiskScore: 1,
    reportCount1930: 0,
    isKnownMule: false,
    deviceFingerprint: 'HEALTHCARE_GATEWAY_CERT_001',
    ipLocation: 'Chennai Healthcare Gateway',
    avgDailyVolume: 38000000
  },
  'irctc.tickets@sbi': {
    vpa: 'irctc.tickets@sbi',
    name: 'Indian Railway Catering and Tourism Corp (IRCTC)',
    category: 'merchant',
    kycStatus: 'verified',
    accountAgeDays: 4000,
    baseRiskScore: 1,
    reportCount1930: 0,
    isKnownMule: false,
    deviceFingerprint: 'GOVT_RAILWAY_CERT_001',
    ipLocation: 'New Delhi Railway Gateway',
    avgDailyVolume: 120000000
  },
  'airtel.broadband@axis': {
    vpa: 'airtel.broadband@axis',
    name: 'Bharti Airtel Limited (Broadband)',
    category: 'merchant',
    kycStatus: 'verified',
    accountAgeDays: 3500,
    baseRiskScore: 1,
    reportCount1930: 0,
    isKnownMule: false,
    deviceFingerprint: 'TELECOM_GATEWAY_CERT_001',
    ipLocation: 'Gurugram Telecom Gateway',
    avgDailyVolume: 65000000
  },
  'aiims.delhi@sbi': {
    vpa: 'aiims.delhi@sbi',
    ...
    reportCount1930: 0,
    isKnownMule: false,
    deviceFingerprint: 'GOVT_HOSPITAL_CERT_001',
    ipLocation: 'New Delhi Hospital Gateway',
    avgDailyVolume: 25000000
  },
  'amazon.seller@hdfcbank': {
    vpa: 'amazon.seller@hdfcbank',
    ...
    reportCount1930: 0,
    isKnownMule: false,
    deviceFingerprint: 'ECOMMERCE_GATEWAY_CERT_001',
    ipLocation: 'Bengaluru Datacenter',
    avgDailyVolume: 180000000
  },
  'dmart.retail@axis': {
    vpa: 'dmart.retail@axis',
    ...
    reportCount1930: 0,
    isKnownMule: false,
    deviceFingerprint: 'RETAIL_GATEWAY_CERT_001',
    ipLocation: 'Mumbai Retail Gateway',
